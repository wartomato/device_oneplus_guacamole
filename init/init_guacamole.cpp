...
// #include "property_service.h" usually turned off because of missing chroma.h
...
void vendor_load_properties()
{
    ...
    if (project_name == 18821 ) {
        ...
        if (rf_version == 4) {
            /* We are Europe */
            property_override("ro.build.fingerprint", "OnePlus/OnePlus7Pro_EEA/OnePlus7Pro:12/SKQ1.211113.001/P.202212242003:user/release-keys");
            for (const auto &source : ro_product_props_default_source_order) {
